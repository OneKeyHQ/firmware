...
def sign_tx(
    ...
    resp = client.call(
        messages.KaspaSignTx(
            address_n=addresses[0],
    ...
    while isinstance(resp, messages.KaspaTxInputRequest):
        ...
        resp = client.call(
            messages.KaspaTxInputAck(
                address_n=addresses[resp.request_index if len(addresses) > 1 else 0],
