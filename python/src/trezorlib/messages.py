...
class TonSignMessage(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        22: protobuf.Field("signing_message_hash", "bytes", repeated=False, required=False),
    }
    ...
    def __init__(
        ...
        *,
        ...
        signing_message_hash: Optional["bytes"] = None,
    ) -> None:
        self.address_n: Sequence["int"] = address_n if address_n is not None else []
        ...
        self.signing_message_hash = signing_message_hash
