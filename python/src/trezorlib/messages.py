...
class TronContract(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        54: protobuf.Field("freeze_balance_v2_contract", "FreezeBalanceV2Contract", repeated=False, required=False, default=None),
        55: protobuf.Field("unfreeze_balance_v2_contract", "UnfreezeBalanceV2Contract", repeated=False, required=False, default=None),
        56: protobuf.Field("withdraw_expire_unfreeze_contract", "WithdrawExpireUnfreezeContract", repeated=False, required=False, default=None),
        57: protobuf.Field("delegate_resource_contract", "DelegateResourceContract", repeated=False, required=False, default=None),
        58: protobuf.Field("undelegate_resource_contract", "UnDelegateResourceContract", repeated=False, required=False, default=None),
    }
    ...
    def __init__(
        ...
        *,
        ...
        freeze_balance_v2_contract: Optional["FreezeBalanceV2Contract"] = None,
        unfreeze_balance_v2_contract: Optional["UnfreezeBalanceV2Contract"] = None,
        withdraw_expire_unfreeze_contract: Optional["WithdrawExpireUnfreezeContract"] = None,
        delegate_resource_contract: Optional["DelegateResourceContract"] = None,
        undelegate_resource_contract: Optional["UnDelegateResourceContract"] = None,
    ) -> None:
