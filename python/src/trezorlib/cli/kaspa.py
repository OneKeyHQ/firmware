...
@cli.command()
@click.option(
    "-n", "--address", required=True, help="BIP-32 path", default="m/44'/111111'/0'/0/0"
)
...
@click.option(
    ...
    "--schema",
    type=str,
    help="address schema (options: schnorr, ecdsa)",
    default="schnorr",
)
@with_client
def get_address(
...
@cli.command()
@click.option(
    "-n", "--address", required=True, help=PATH_HELP, default="m/44'/111111'/0'/0/0"
)
@click.option("-p", "--prefix", help="Address prefix", default="kaspa")
@click.option(
    "-s",
    "--schema",
    type=str,
    help="signature schema (options: schnorr, ecdsa)",
    default="schnorr",
)
@click.argument("message")
@with_client
def sign_tx(
    client: "TrezorClient", address: str, message: str, prefix: str, schema: str
):
