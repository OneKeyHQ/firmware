...
@with_client
def bixin(client: "TrezorClient", is_bixinapp: bool):
    """set bixin app."""
...
@with_client
def se(client: "TrezorClient", use_se: bool):
    """use/unuse se chip."""
...
def ble(client: "TrezorClient", use_ble: bool):
...
@with_client
def language(client: "TrezorClient", language: str):
    """set language."""
