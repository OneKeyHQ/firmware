...
ClearSession = 24  # type: Literal[24]f
...
FirmwareErase_ex = 16  # type: Literal[16]
...
BixinReboot = 903  # type: Literal[903]
BixinOutMessageSE = 904  # type: Literal[904]
BixinBackupRequest = 905  # type: Literal[905]
BixinBackupAck = 906  # type: Literal[906]
BixinRestoreRequest = 907  # type: Literal[907]
BixinRestoreAck = 908  # type: Literal[908]
BixinVerifyDeviceRequest = 909  # type: Literal[909]
