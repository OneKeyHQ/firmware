...
PingRequest = 805  # type: Literal[805]
PingReply = 806  # type: Literal[806]
InitRequest = 807  # type: Literal[807]
InitReply = 808  # type: Literal[808]
GetExtPubKeyRequest = 809  # type: Literal[809]
GetExtPubKeyReply = 810  # type: Literal[810]
NewChannelRequest = 811  # type: Literal[811]
NewChannelReply = 812  # type: Literal[812]
ReadyChannelRequest = 813  # type: Literal[813]
ReadyChannelReply = 814  # type: Literal[814]
SignMutualCloseTxRequest = 815  # type: Literal[815]
SignatureReply = 816  # type: Literal[816]
CheckFutureSecretRequest = 817  # type: Literal[817]
CheckFutureSecretReply = 818  # type: Literal[818]
GetChannelBasepointsRequest = 819  # type: Literal[819]
GetChannelBasepointsReply = 820  # type: Literal[820]
GetPerCommitmentPointRequest = 821  # type: Literal[821]
GetPerCommitmentPointReply = 822  # type: Literal[822]
SignFundingTxRequest = 823  # type: Literal[823]
SignFundingTxReply = 824  # type: Literal[824]
SignRemoteCommitmentTxRequest = 825  # type: Literal[825]
SignCommitmentTxRequest = 826  # type: Literal[826]
SignLocalHTLCTxRequest = 827  # type: Literal[827]
SignDelayedPaymentToUsRequest = 828  # type: Literal[828]
SignRemoteHTLCTxRequest = 829  # type: Literal[829]
SignRemoteHTLCToUsRequest = 830  # type: Literal[830]
SignPenaltyToUsRequest = 831  # type: Literal[831]
SignChannelAnnouncementRequest = 832  # type: Literal[832]
SignChannelAnnouncementReply = 833  # type: Literal[833]
SignNodeAnnouncementRequest = 834  # type: Literal[834]
NodeSignatureReply = 835  # type: Literal[835]
SignChannelUpdateRequest = 836  # type: Literal[836]
ECDHRequest = 837  # type: Literal[837]
ECDHReply = 838  # type: Literal[838]
SignInvoiceRequest = 839  # type: Literal[839]
RecoverableNodeSignatureReply = 840  # type: Literal[840]
SignMessageRequest = 841  # type: Literal[841]
VersionRequest = 842  # type: Literal[842]
VersionReply = 843  # type: Literal[843]
NodeConfig = 844  # type: Literal[844]
ChainParams = 845  # type: Literal[845]
NodeId = 846  # type: Literal[846]
ChannelNonce = 847  # type: Literal[847]
PubKey = 848  # type: Literal[848]
Secret = 849  # type: Literal[849]
BIP32Seed = 850  # type: Literal[850]
Transaction = 851  # type: Literal[851]
Basepoints = 852  # type: Literal[852]
ECDSASignature = 853  # type: Literal[853]
ECDSARecoverableSignature = 854  # type: Literal[854]
BitcoinSignature = 855  # type: Literal[855]
ExtPubKey = 856  # type: Literal[856]
KeyLocator = 857  # type: Literal[857]
TxOut = 858  # type: Literal[858]
UnilateralCloseInfo = 860  # type: Literal[860]
InputDescriptor = 861  # type: Literal[861]
OutputDescriptor = 862  # type: Literal[862]
Witness = 863  # type: Literal[863]
SignRemoteCommitmentTxPhase2Request = 864  # type: Literal[864]
SignLocalCommitmentTxPhase2Request = 865  # type: Literal[865]
CommitmentTxSignatureReply = 866  # type: Literal[866]
SignMutualCloseTxPhase2Request = 867  # type: Literal[867]
CloseTxSignatureReply = 868  # type: Literal[868]
HTLCInfo = 869  # type: Literal[869]
CommitmentInfo = 870  # type: Literal[870]
Outpoint = 871  # type: Literal[871]
