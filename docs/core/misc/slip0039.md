...
This does not quite match Onekey's use of the "passphrase protection" feature, namely
...
## Seed handling in Onekey

Onekey stores a _mnemonic secret_ in a storage field `_MNEMONIC_SECRET`. This is the
...
Only the functions denoted in **bold** are implemented in onekey-core. Recovery shares
