...
class Screen_Generic(Screen):
    ...
    def __init__(
        ...
        if return_btn:
            ...
            self.btn_return.add_event_cb(self.btn_cancel_eventhandler, lv.EVENT.CLICKED, None)
            self.btn_return.set_style_bg_opa(lv.OPA.TRANSP, lv.PART.MAIN| lv.STATE.DEFAULT )
        ...
        if title:
            ...
            self.label_title.set_style_text_opa(lv.OPA.COVER, lv.PART.MAIN| lv.STATE.DEFAULT )
        ...
        if description:
            ...
            self.label_description.set_style_text_font( lv.font_montserrat_20, lv.PART.MAIN | lv.STATE.DEFAULT )
        ...
        if cancel_btn:
            ...
            self.btn_cancel.add_event_cb(self.btn_cancel_eventhandler, lv.EVENT.CLICKED, None)
            ...
            if not cancel_text:
                ...
                self.label_cancel.set_style_text_color( lv.color_hex(0xFFFFFF), lv.PART.MAIN | lv.STATE.DEFAULT )
                self.label_cancel.set_style_text_font( lv.font_montserrat_20, lv.PART.MAIN | lv.STATE.DEFAULT )
        ...
        if confirm_text:
            ...
            self.btn_confirm.add_event_cb(self.btn_confirm_eventhandler, lv.EVENT.CLICKED, None)
            ...
            self.label_confirm.set_style_text_color( lv.color_hex(0x000000), lv.PART.MAIN | lv.STATE.DEFAULT )
            self.label_confirm.set_style_text_font( lv.font_montserrat_20, lv.PART.MAIN | lv.STATE.DEFAULT )        
...
class WordsGrid():
    def __init__(self,parent,words):
        ...
        for index, word in words:
            ...
            label.center()
            label.set_style_text_font( lv.font_montserrat_20, lv.PART.MAIN | lv.STATE.DEFAULT )
...
class CandidateWordList():
    def __init__(self,parent,words):
        ...
        self.list_candidate.set_style_bg_opa(lv.OPA.TRANSP, lv.PART.MAIN| lv.STATE.DEFAULT )
...
class Screen_WordCount(Screen_Generic):
    def __init__(
        ...
        self.btnm.set_style_text_font( lv.font_montserrat_20, lv.PART.ITEMS | lv.STATE.DEFAULT )
...
class Screen_WordInput(Screen_Generic):
    def __init__(
        ...
        self.textarea_word.add_event_cb(self.textarea_input_eventhandler, lv.EVENT.ALL, None)
        self.textarea_word.set_style_border_width( 0, lv.PART.MAIN | lv.STATE.DEFAULT )
        self.textarea_word.set_style_text_align( lv.TEXT_ALIGN.CENTER, lv.PART.MAIN | lv.STATE.DEFAULT )
        self.textarea_word.set_style_text_color( lv.color_hex(0xFFFFFF), lv.PART.MAIN | lv.STATE.DEFAULT )
        self.textarea_word.set_style_bg_opa(lv.OPA.TRANSP, lv.PART.MAIN| lv.STATE.DEFAULT )
        ...
        self.keyboard.set_style_bg_color( lv.color_hex(0x323232), lv.PART.ITEMS | lv.STATE.DEFAULT )
        self.keyboard.set_style_text_color( lv.color_hex(0xFFFFFF), lv.PART.ITEMS | lv.STATE.DEFAULT )
        self.keyboard.set_style_text_font( lv.font_montserrat_20, lv.PART.ITEMS | lv.STATE.DEFAULT )
...
class Screen_InputPIN(Screen_Generic):
    def __init__(self, title: str=None, description: str=None, allow_cancel: bool=True):
        super().__init__(
            return_btn=allow_cancel,
            title= title,
            description=description
        )
        ...
        self.textarea_pin.set_style_text_opa(lv.OPA.COVER, lv.PART.MAIN| lv.STATE.DEFAULT )
        ...
        self.textarea_pin.set_style_bg_opa(lv.OPA.COVER, lv.PART.MAIN| lv.STATE.DEFAULT )
