...
APP__USER_GUIDE = 172
# Ready to Create
TITLE__READY_TO_CREATE = 173
# The next screen will show the passphrase you entered on the connected device
# .
SUBTITLE__ENTER_PASSPHRASE_ACCESS_HIDDEN_WALLET = 174
# Access Hidden Wallet?
TITLE__ACCESS_HIDDEN_WALLET = 175
# This is the wrong word, check and enter again.
SUBTITLE__DEVICE_BACKUP_INCORRECT_WORD = 176
# Incorrect Word
TITLE__INCORRECT_WORD = 177
# Use This Passphrase?
TITLE__USE_THIS_PASSPHRASE = 178
# Model
ITEM__MODEL = 179
# Storage
ITEM__STORAGE = 180
...
ITEM__SERIAL = 181
# System Version
ITEM__SYSTEM_VERSION = 182
# Incorrect PIN, this is your last attempt.
MSG__INCORRECT_PIN_THIS_IS_YOUR_LAST_ATTEMPT = 183
# Modify Fee
TITLE__MODIFY_FEE = 184
# AMOUNT (YOU SPEND):
LIST_KEY__AMOUNT_YOU_SPEND__COLON = 185
# NEW FEE:
LIST_KEY__NEW_FEE__COLON = 186
# Modify Amount
TITLE__MODIFY_AMOUNT = 187
# NEW AMOUNT:
LIST_KEY__NEW_AMOUNT__COLON = 188
# TRANSACTION ID:
LIST_KEY__TRANSACTION_ID__COLON = 189
# COIN NAME:
LIST_KEY__COIN_NAME__COLON = 190
# MAXIMUM ROUNDS:
LIST_KEY__MAXIMUM_ROUNDS__COLON = 191
# MAXIMUM MINING FEE:
LIST_KEY__MAXIMUM_MINING_FEE__COLON = 192
# IDENTITY:
LIST_KEY__IDENTITY__COLON = 193
# Confirm Transfer
TITLE__CONFIRM_TRANSFER = 194
# APP NAME:
LIST_KEY__APP_NAME__COLON = 195
# ACCOUNT NAME:
LIST_KEY__ACCOUNT_NAME__COLON = 196
# Confirm {} Payment
TITLE__CONFIRM_PAYMENT = 197
# Sign {} Joint Transaction
TITLE__SIGN_STR_JOINT_TX = 198
# DECREASED BY:
LIST_KEY__DECREASED_BY__COLON = 199
# INCREASED BY:
LIST_KEY__INCREASED_BY__COLON = 200
# NO CHANGE:
LIST_KEY__NO_CHANGE__COLON = 201
# Authorize CoinJoin
TITLE__AUTHORIZE_COINJOIN = 202
# Verify {} Message
TITLE__VERIFY_STR_MESSAGE = 203
# Enter pair code on your device.
SUBTITLE__BLUETOOTH_PAIR = 204
# Bluetooth Pair
TITLE__BLUETOOTH_PAIR = 205
# Incorrect pair code, try again.
SUBTITLE__BLUETOOTH_PAIR_NOT_MATCH = 206
# {} seconds
OPTION__STR_SECONDS = 207
# {} hours
OPTION__STR_HOUR = 208
# Custom
OPTION__CUSTOM__INSERT = 209
# View Data
TITLE__VIEW_DATA = 210
# SIZE:
LIST_KEY__SIZE__COLON = 211
# DATA:
LIST_KEY__DATA__COLON = 212
# Do you really want to auto-lock your device after {}?
SUBTITLE__DO_YOU_REALLY_WANT_TO_AUTO_LOCK_YOUR_DEVICE_AFTER_STR = 213
# Safety Override
TITLE__SAFETY_OVERRIDE = 214
# OneKey will allow you to approve some actions which might be unsafe.
SUBTITLE__ONEKEY_WILL_ALLOW_YOU_TO_APPROVE_SOME_ACTIONS_WHICH_MIGHT_BE_UNSAFE = 215
# OneKey will temporarily allow you to approve some actions which might be uns
# afe.
SUBTITLE__ONEKEY_WILL_TEMPORARILY_ALLOW_YOU_TO_APPROVE_SOME_ACTIONS_WHICH_MIGHT_BE_UNSAFE = 216
# Safety checks
TITLE__SAFETY_CHECKS = 217
# Do you really want to enforce strict safety checks (recommended)?
SUBTITLE__DO_YOU_REALLY_WANT_TO_ENFORCE_STRICT_SAFETY_CHECKS_RECOMMENDED = 218
# Experimental mode
TITLE__EXPERIMENTAL_MODE = 219
# Enable experimental features?
SUBTITLE__ENABLE_EXPERIMENTAL_FEATURES = 220
# Please Wait
TITLE__PLEASE_WAIT = 221
# new contract?
LIST_VALUE__NEW_CONTRACT = 222
# Confirm Fee
TITLE__CONFIRM_FEE = 223
# Confirm Data
TITLE__CONFIRM_DATA = 224
# {} bytes
SUBTITLE__STR_BYTES = 225
# Confirm Typed Data
TITLE__CONFIRM_TYPED_DATA = 226
# Really sign EIP-712 typed data?
SUBTITLE__REALLY_SIGN_EIP_712_TYPED_DATA = 227
# Confirm Message
TITLE__CONFIRM_MESSAGE = 228
# No message field
SUBTITLE__NO_MESSAGE_FIELD = 229
# Confirm Transaction
TITLE__CONFIRM_TRANSACTION = 230
# TRANSACTION FEE:
LIST_KEY__TRANSACTION_FEE_COLON = 231
# Confirm Locktime
TITLE__CONFIRM_LOCKTIME = 232
# Set locktime for this transaction
SUBTITLE__SET_LOCKTIME_FOR_THIS_TRANSACTION = 233
# TIME:
LIST_KEY__TIME_COLON = 234
# High fee
TITLE__HIGH_FEE = 235
# The fee is unexpectedly high.
SUBTITLE__THE_FEE_IS_UNEXPECTEDLY_HIGH = 236
# There are too many change-outputs.
SUBTITLE__THERE_ARE_TOO_MANY_CHANGE_OUTPUTS = 237
# Locktime is set but will have no effect.
SUBTITLE__LOCKTIME_IS_SET_BUT_WILL_HAVE_NO_EFFECT = 238
# Locktime for this transaction is set to blockheight
SUBTITLE__LOCKTIME_FOR_THIS_TRANSACTION_IS_SET_TO_BLOCKHEIGHT = 239
# BLOCK HEIGHT:
LIST_KEY__BLOCK_HEIGHT_COLON = 240
# Transaction fee
SUBTITLE__TRANSACTION_FEE = 241
# CHANGE COUNT:
LIST_KEY__CHANGE_COUNT_COLON = 242
# FIDO2 Reset
TITLE__FIDO2_RESET = 243
# Do you really want to erase all credentials?
SUBTITLE__DO_YOU_REALLY_WANT_TO_ERASE_ALL_CREDENTIALS = 244
# Get Next U2F Counter
TITLE__GET_NEXT_U2F_COUNTER = 245
# Do you want to increase and retrieve the U2F counter?
SUBTITLE__GET_NEXT_U2F_COUNTER = 246
# List Credentials
TITLE__LIST_CREDENTIALS = 247
# Do you want to export information about the resident credentials stored on t
# his device?
SUBTITLE__LIST_CREDENTIALS = 248
# Set U2F Counter
TITLE__SET_U2F_COUNTER = 249
# Do you want to set the U2F counter to {}?
SUBTITLE__SET_U2F_COUNTER = 250
# Remove Credential
TITLE__REMOVE_CREDENTIAL = 251
# View Full Message
BUTTON__VIEW_FULL_MESSAGE = 252
# Import Credential
TITLE__IMPORT_CREDENTIAL = 253
# The credential you are trying to import does not belong to this authenticato
# r.
SUBTITLE__IMPORT_CREDENTIAL = 254
# Pair Failed
TITLE__PAIR_FAILED = 255
# Bluetooth pairing failed, Try connecting again.
SUBTITLE__BLUETOOTH_PAIR_PAIR_FAILED = 256
# I have written down the words. Then following the guide to check words one b
# y one.
CHECK__I_HAVE_WRITE_DOWN_THE_WORDS = 257
# SEEDLESS
MSG__SEEDLESS = 258
# BACKUP FAILED!
MSG__BACKUP_FAILED = 259
# NEEDS BACKUP!
MSG__NEEDS_BACKUP = 260
# PIN NOT SET!
MSG__PIN_NOT_SET = 261
# EXPERIMENTAL MODE
MSG__EXPERIMENTAL_MODE = 262
# U2F Already Registered
TITLE__U2F_ALREADY_REGISTERED = 263
# This device is already registered with this application.
SUBTITLE__U2F_ALREADY_REGISTERED = 264
# U2F Not Registered
TITLE__U2F_NOT_REGISTERED = 265
# This device is not registered with this application.
SUBTITLE__U2F_NOT_REGISTERED = 266
# FIDO2 Already Registered
TITLE__FIDO2_ALREADY_REGISTERED = 267
# U2F Register
TITLE__U2F_REGISTER = 268
# U2F Authenticate
TITLE__U2F_AUTHENTICATE = 269
# This device is already registered with {}.
SUBTITLE__THIS_DEVICE_IS_AREADY_REGISTERED_WITH_STR = 270
# FIDO2 Verify User
TITLE__FIDO2_VERIFY_USER = 271
# Unable to verify user, please enable PIN protection.
SUBTITLE__FIDO2_VERIFY_USER = 272
# FIDO2 Authenticate Not Registered
TITLE__FIDO2_AUTHENTICATE_NOT_REGISTERED = 273
# This device is not registered with application {}.
SUBTITLE__FIDO2_AUTHENTICATE_NOT_REGISTERED = 274
# FIDO2 Register
TITLE__FIDO2_REGISTER = 275
# FIDO2 Authenticate
TITLE__FIDO2_AUTHENTICATE = 276
# fmt: on
