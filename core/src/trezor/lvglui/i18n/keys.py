...
ITEM__RESET_PIN = 155
# Reset Device
ITEM__RESET_DEVICE = 156
# Passphrase
ITEM__PASSPHRASE = 157
# Off
ITEM__STATUS__OFF = 158
# Ethereum
TITLE__ETHEREUM = 159
# Blind Signing
ITEM__BLIND_SIGNING = 160
TITLE__BLIND_SIGNING = 160
# On
ITEM__STATUS__ON = 161
# {} Blind Signing is now disabled.
ITEM__FOOT__STR_BLIND_SIGNING_DISABLED = 162
# {} Blind Signing
ITEM__STR_BLIND_SIGNING = 163
...
# you need to know:
SUBTITLE_SETTING_CRYPTO_BLIND_SIGN_ENABLED = 164
# It's recommended to disable this feature after use.
CHECK__CRYPTO_BLIND_SIGN_ENABLED_2 = 165
# Enabling blind signing will have certain security risks.
CHECK__CRYPTO_BLIND_SIGN_ENABLED_1 = 166
# Enable {} Blind Signing?
TITLE__ENABLE_STR_BLIND_SIGNING = 167
# Enable
BUTTON__ENABLE = 168
# Solana
TITLE__SOLANA = 169
# {} Blind Signing is now enabled.
ITEM__FOOT__STR_BLIND_SIGNING_ENABLED = 170
# Shutting Down...
TITLE__SHUTTING_DOWN = 171
# Tap to Unlock
LOCKED_TEXT__TAP_TO_UNLOCK = 172
# User Guide
APP__USER_GUIDE = 173
# Ready to Create
