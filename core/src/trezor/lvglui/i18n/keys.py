...
CHECK__DEVICE_BACK_UP_RECOVERY_PHRASE_3 = 26
...
CHECK__DEVICE_BACK_UP_RECOVERY_PHRASE_2 = 29
# If you lose recovery phrase, you will lose all your fund.
CHECK__DEVICE_BACK_UP_RECOVERY_PHRASE_1 = 30
# Hold to Confirm
BUTTON__HOLD_TO_CONFIRM = 31
...
SUBTITLE__DEVICE_SETUP_READY_TO_CREATE = 51
# Ready to Restore
...
ITEM__CHECK_RECOVERY_PHRASE = 61
# Abort Check
...
SUBTITLE__SET_PIN_WRONG_PIN = 72
# Wrong PIN
TITLE__WRONG_PIN = 73
# PIN Changed
TITLE__PIN_CHANGED = 74
# You have successfully changed your PIN.
SUBTITLE__SET_PIN_PIN_CHANGED = 75
# Done
BUTTON__DONE = 76
# PIN Disabled
TITLE__PIN_DISABLED = 77
# You have successfully disabled PIN protection.
SUBTITLE__SET_PIN_PIN_DISABLED = 78
# Enter PIN
TITLE__ENTER_PIN = 79
# Incorrect PIN, {} attempts left.
MSG__INCORRECT_PIN_STR_ATTEMPTS_LEFT = 80
# Enable Passphrase
...
# Passphrase Source
TITLE__PASSPHRASE_SOURCE = 86
# Do you want to revoke the setting of always enter passphrase on the device?
SUBTITLE__SET_PASSPHRASE_ENABLED_NO_FORCE_ON_DEVICE = 87
# Enter Passphrase
TITLE__ENTER_PASSPHRASE = 88
# Please type your passphrase on the connected device.
SUBTITLE__ENTER_PASSPHRASE_ON_SOFTWARE = 89
# Verify PIN
...
CHECK__DEVICE_WIPE_DEVICE_FACTORY_RESET_1 = 94
# Hold to Reset
BUTTON__HOLD_TO_RESET = 95
# You can still restore your funds from recovery phrase backup.
CHECK__DEVICE_WIPE_DEVICE_FACTORY_RESET_2 = 96
# This will erase all data on internal storage and Secure Element (SE). Before
# hand, you need to know:
SUBTITLE__DEVICE_WIPE_DEVICE_FACTORY_RESET = 97
# Device reset successfully, restart system now.
SUBTITLE__DEVICE_WIPE_DEVICE_RESET_COMPLETE = 98
# Reset Complete
TITLE__RESET_COMPLETE = 99
# Restart
BUTTON__RESTART = 100
# {} Address
TITLE__STR_ADDRESS = 101
# Path:
LIST_KEY__PATH__COLON = 102
# Address:
LIST_KEY__ADDRESS__COLON = 103
# Export
BUTTON__EXPORT = 104
# Public Key:
LIST_KEY__PUBLIC_KEY__COLON = 105
# {} Public Key
TITLE__STR_PUBLIC_KEY = 106
# Message:
LIST_KEY__MESSAGE__COLON = 107
# Sign
BUTTON__SIGN = 108
# Sign {} Message
TITLE__SIGN_STR_MESSAGE = 109
# TO
INSERT__TO = 110
# View Transaction
TITLE__VIEW_TRANSACTION = 111
# SEND
INSERT__SEND = 112
# Reject
BUTTON__REJECT = 113
# Sign {} Transaction
TITLE__SIGN_STR_TRANSACTION = 114
# Hold to Sign
BUTTON__HOLD_TO_SIGN = 115
# Amount:
LIST_KEY__AMOUNT__COLON = 116
# Gas Price:
LIST_KEY__GAS_PRICE__COLON = 117
# Maximum Fee:
LIST_KEY__MAXIMUM_FEE__COLON = 118
# To:
LIST_KEY__TO__COLON = 119
# Total Amount:
LIST_KEY__TOTAL_AMOUNT__COLON = 120
# From:
LIST_KEY__FROM__COLON = 121
# Maximum Fee Per Gas:
LIST_KEY__MAXIMUM_FEE_PER_GAS__COLON = 122
# Proirity Fee Per Gas:
LIST_KEY__PRIORITY_FEE_PER_GAS__COLON = 123
# Contract:
...
# xPub #{} (mine):
LIST_KEY__XPUB_STR_MINE__COLON = 131
# {} Multisig Address\n({} of {})
TITLE__STR_MULTISIG_ADDRESS_STR_OF_STR = 132
# xPub #{} (cosigner):
LIST_KEY__XPUB_STR_COSIGNER__COLON = 133
# xPub:
LIST_KEY__XPUB__COLON = 134
# {} Descriptor
TITLE__STR_DESCRIPTOR = 135
# Fee:
LIST_KEY__FEE__COLON = 136
# Export Watch-Key
TITLE__EXPORT_WATCH_KEY = 137
# Do you want to export watch-only credentials?
SUBTITLE__MONERO_GET_WATCH_KEY = 138
# Network:
LIST_KEY__NETWORK__COLON = 139
# Home Screen
ITEM__HOME_SCREEN = 140
TITLE__HOME_SCREEN = 140
# Security
ITEM__SECURITY = 141
TITLE__SECURITY = 141
# General
...
TITLE__LANGUAGE = 149
# {} minutes
ITEM__STATUS__STR_MINUTES = 150
# Never
ITEM__STATUS__NEVER = 151
OPTION__NEVER = 151
# {} minute
OPTION__STR_MINUTES = 152
# Bluetooth
ITEM__BLUETOOTH = 153
# USB
ITEM__USB = 154
...
TITLE__ETHEREUM = 158
# Blind Signing
ITEM__BLIND_SIGNING = 159
TITLE__BLIND_SIGNING = 159
# On
ITEM__STATUS__ON = 160
# {} Blind Signing is now disabled.
ITEM__FOOT__STR_BLIND_SIGNING_DISABLED = 161
# {} Blind Signing
ITEM__STR_BLIND_SIGNING = 162
...
# you need to know:
SUBTITLE_SETTING_CRYPTO_BLIND_SIGN_ENABLED = 163
# It's recommended to disable this feature after use.
CHECK__CRYPTO_BLIND_SIGN_ENABLED_2 = 164
# Enabling blind signing will have certain security risks.
CHECK__CRYPTO_BLIND_SIGN_ENABLED_1 = 165
# Enable {} Blind Signing?
TITLE__ENABLE_STR_BLIND_SIGNING = 166
# Enable
BUTTON__ENABLE = 167
# Solana
TITLE__SOLANA = 168
# {} Blind Signing is now enabled.
ITEM__FOOT__STR_BLIND_SIGNING_ENABLED = 169
# Shutting Down...
TITLE__SHUTTING_DOWN = 170
# Tap to Unlock
LOCKED_TEXT__TAP_TO_UNLOCK = 171
# User Guide
APP__USER_GUIDE = 172
# Setting
APP__SETTING = 173
# Ready to Create
TITLE__READY_TO_CREATE = 174
...
# Experimental mode
TITLE__EXPERIMENTAL_MODE = 215
# Enable experimental features?
SUBTITLE__ENABLE_EXPERIMENTAL_FEATURES = 216
# Please Wait
TITLE__PLEASE_WAIT = 217
# new contract?
LIST_VALUE__NEW_CONTRACT = 218
# Confirm Fee
TITLE__CONFIRM_FEE = 219
# Confirm Data
TITLE__CONFIRM_DATA = 220
# {} bytes
SUBTITLE__STR_BYTES = 221
# Confirm Typed Data
TITLE__CONFIRM_TYPED_DATA = 222
# Really sign EIP-712 typed data?
SUBTITLE__REALLY_SIGN_EIP_712_TYPED_DATA = 223
# Confirm Message
TITLE__CONFIRM_MESSAGE = 224
# No message field
SUBTITLE__NO_MESSAGE_FIELD = 225
# Confirm Transaction
TITLE__CONFIRM_TRANSACTION = 226
# Transaction Fee:
LIST_KEY__TRANSACTION_FEE_COLON = 227
# Confirm Locktime
TITLE__CONFIRM_LOCKTIME = 228
# Set locktime for this transaction
SUBTITLE__SET_LOCKTIME_FOR_THIS_TRANSACTION = 229
# Time:
LIST_KEY__TIME_COLON = 230
# High fee
TITLE__HIGH_FEE = 231
# The fee is unexpectedly high.
SUBTITLE__THE_FEE_IS_UNEXPECTEDLY_HIGH = 232
# There are too many change-outputs.
SUBTITLE__THERE_ARE_TOO_MANY_CHANGE_OUTPUTS = 233
# Locktime is set but will have no effect.
SUBTITLE__LOCKTIME_IS_SET_BUT_WILL_HAVE_NO_EFFECT = 234
# Locktime for this transaction is set to blockheight
SUBTITLE__LOCKTIME_FOR_THIS_TRANSACTION_IS_SET_TO_BLOCKHEIGHT = 235
# Block Height:
LIST_KEY__BLOCK_HEIGHT_COLON = 236
# Transaction fee
SUBTITLE__TRANSACTION_FEE = 237
# Change Count:
LIST_KEY__CHANGE_COUNT_COLON = 238
# FIDO2 Reset
TITLE__FIDO2_RESET = 239
# Do you really want to erase all credentials?
SUBTITLE__DO_YOU_REALLY_WANT_TO_ERASE_ALL_CREDENTIALS = 240
# Get Next U2F Counter
TITLE__GET_NEXT_U2F_COUNTER = 241
# Do you want to increase and retrieve the U2F counter?
SUBTITLE__GET_NEXT_U2F_COUNTER = 242
# List Credentials
TITLE__LIST_CREDENTIALS = 243
# Do you want to export information about the resident credentials stored on t
# his device?
SUBTITLE__LIST_CREDENTIALS = 244
# Set U2F Counter
TITLE__SET_U2F_COUNTER = 245
# Do you want to set the U2F counter to {}?
SUBTITLE__SET_U2F_COUNTER = 246
# Remove Credential
TITLE__REMOVE_CREDENTIAL = 247
# View Full Message
BUTTON__VIEW_FULL_MESSAGE = 248
# Import Credential
TITLE__IMPORT_CREDENTIAL = 249
# The credential you are trying to import does not belong to this authenticato
# r.
SUBTITLE__IMPORT_CREDENTIAL = 250
# Pair Failed
TITLE__PAIR_FAILED = 251
# Bluetooth pairing failed, Try connecting again.
SUBTITLE__BLUETOOTH_PAIR_PAIR_FAILED = 252
# I have written down the words. Then following the guide to check words one b
# y one.
CHECK__I_HAVE_WRITE_DOWN_THE_WORDS = 253
# SEEDLESS
MSG__SEEDLESS = 254
# BACKUP FAILED!
MSG__BACKUP_FAILED = 255
# NEEDS BACKUP!
MSG__NEEDS_BACKUP = 256
# PIN NOT SET!
MSG__PIN_NOT_SET = 257
# EXPERIMENTAL MODE
MSG__EXPERIMENTAL_MODE = 258
# U2F Already Registered
TITLE__U2F_ALREADY_REGISTERED = 259
# This device is already registered with this application.
SUBTITLE__U2F_ALREADY_REGISTERED = 260
# U2F Not Registered
TITLE__U2F_NOT_REGISTERED = 261
# This device is not registered with this application.
SUBTITLE__U2F_NOT_REGISTERED = 262
# FIDO2 Already Registered
TITLE__FIDO2_ALREADY_REGISTERED = 263
# U2F Register
TITLE__U2F_REGISTER = 264
# U2F Authenticate
TITLE__U2F_AUTHENTICATE = 265
# This device is already registered with {}.
SUBTITLE__THIS_DEVICE_IS_AREADY_REGISTERED_WITH_STR = 266
# FIDO2 Verify User
TITLE__FIDO2_VERIFY_USER = 267
# Unable to verify user, please enable PIN protection.
SUBTITLE__FIDO2_VERIFY_USER = 268
# FIDO2 Authenticate Not Registered
TITLE__FIDO2_AUTHENTICATE_NOT_REGISTERED = 269
# This device is not registered with application {}.
SUBTITLE__FIDO2_AUTHENTICATE_NOT_REGISTERED = 270
# FIDO2 Register
TITLE__FIDO2_REGISTER = 271
# FIDO2 Authenticate
TITLE__FIDO2_AUTHENTICATE = 272
# Brightness
TITLE__BRIGHTNESS = 273
ITEM__BRIGHTNESS = 273
# View Full Data
BUTTON__VIEW_FULL_DATA = 274
# Confirm {}
TITLE__CONFIRM_STR = 275
# View Full Struct
BUTTON__VIEW_FULL_STRUCT = 276
# View Full Array
BUTTON__VIEW_FULL_ARRAY = 277
# Sign Typed Data
TITLE__SIGN_712_TYPED_DATA = 278
# Do you want to sign EIP-712 typed data?
SUBTITLE__SIGN_712_TYPED_DATA = 279
# Contains {} key
LIST_KEY__CONTAINS_STR_KEY = 280
# Array of {} {}
INSERT__ARRAY_OF_STR_STR = 281
# Confirm Domain
TITLE__CONFIRM_DOMAIN = 282
# PIN Keyboard
ITEM__PIN_KEYBOARD = 283
TITLE__PIN_KEYBOARD = 283
# Randomized
OPTION__RANDOMIZED = 284
# Ordered
OPTION__ORDERED = 285
# Power On/Off
TITLE__POWER_ON_OFF__GUIDE = 286
ITEM__POWER_ON_OFF = 286
# Press and hold the power button to power on and off.
SUBTITLE__POWER_ON_OFF__GUIDE = 287
# What is Recovery Phrase?
TITLE__WHAT_IS_RECOVERY_PHRASE__GUIDE = 288
# A human-readable "private key" to generate your wallet. A key to restore all
# your crypto asset.
SUBTITLE__WHAT_IS_RECOVERY_PHRASE__GUIDE = 289
# Enable PIN Protection
TITLE__ENABLE_PIN_PROTECTION__GUIDE = 290
ITEM__ENABLE_PIN_PROTECTION = 290
# System-level security protection mechanism, Set a strong PIN code to secure
# your crypto assets.
SUBTITLE__ENABLE_PIN_PROTECTION__GUIDE = 291
# How Hardware Wallet Works
TITLE__HOW_HARDWARE_WALLET_WORKS__GUIDE = 292
ITEM__HOW_HARDWARE_WALLET_WORKS = 292
...
SUBTITLE__HOW_HARDWARE_WALLET_WORKS__GUIDE = 293
# Passphrase: Access Hidden Wallets
TITLE__PASSPHRASE_ACCESS_HIDDEN_WALLETS__GUIDE = 294
ITEM__PASSPHRASE_ACCESS_HIDDEN_WALLETS = 294
...
# sphrase.
SUBTITLE__PASSPHRASE_ACCESS_HIDDEN_WALLETS__GUIDE = 295
# Need Help?
TITLE__NEED_HELP__GUIDE = 296
ITEM__NEED_HELP = 296
# Have any questions? Go OneKey Support Center for help.
SUBTITLE__NEED_HELP__GUIDE = 297
# What is Recovery Phrase
ITEM__WHAT_IS_RECOVERY_PHRASE = 298
# Guide
TITLE__GUIDE = 299
APP__GUIDE = 299
# Encrypt Value
TITLE__ENCRYPT_VALUE = 300
# Decrypt Value
TITLE__DECRYPT_VALUE = 301
# Enable Labeling?
SUBTITLE__ENABLE_LABELING = 302
# Confirm Entropy
TITLE__CONFIRM_ENTROPY = 303
# Do you want to export entropy? Continue only if you know what you are doing!
SUBTITLE__CONFIRM_ENTROPY = 304
# Extract Firmware
TITLE__EXTRACT_FIRMWARE = 305
# Do you want to extract device firmware? Your recovery phrase will not be rev
# ealed.
SUBTITLE__EXTRACT_FIRMWARE = 306
# Security Check
TITLE__SECURITY_CHECK = 307
...
SUBTITLE__SECURITY_CHECK = 308
# Swipe to Show Apps
BUTTON__SWIPE_TO_SHOW_APPS = 309
# Tap to Close
BUTTON__TAP_TO_CLOSE = 310
# Processing...
BUTTON__PROCESSING = 311
# Slide to Sign
BUTTON__SLIDE_TO_SIGN = 312
# Slide to Reset
BUTTON__SLIDE_TO_RESET = 313
# Slide to Confirm
BUTTON__SLIDE_TO_CONFIRM = 314
# USB Lock
ITEM__USB_LOCK = 315
TITLE__USB_LOCK = 315
# Device will auto lock every time when USB plug or unplug.
CONTENT__USB_LOCK_ENABLED__HINT = 316
# Device will remain unlocked when USB plug or unplug.
CONTENT__USB_LOCK_DISABLED__HINT = 317
# Go to Update Mode
TITLE__GO_TO_UPDATE_MODE = 318
# Do you want to restart device in update mode?
SUBTITLE__GO_TO_UPDATE_MODE = 319
SUBTITLE__SWITCH_TO_UPDATE_MODE_RECONFIRM = 319
# Build ID
ITEM__BUILD_ID = 320
# Wallet
ITEM__WALLET = 321
...
CONTENT__PASSPHRASE_ENABLED__HINT = 322
# Passphrase is disabled.
CONTENT__PASSPHRASE_DISABLED__HINT = 323
# Disable
BUTTON__DISABLE = 324
# Check the phrase you entered and make sure it is correct.
SUBTITLE__USE_THIS_PASSPHRASE = 325
# {} Transfer
TITLE__STR_TRANSFER = 326
# Fee Payer:
LIST_KEY__FEE_PAYER__COLON = 327
# Do you want to sign this transaction?
SUBTITLE__DO_YOU_WANT_TO_SIGN__THIS_TX = 328
# New Token Account:
LIST_KEY__NEW_TOKEN_ACCOUNT = 329
# Mint Address:
LIST_KEY__MINT_ADDRESS = 330
# Owner:
LIST_KEY__OWNER = 331
# Funded By:
LIST_KEY__FUNDED_BY__COLON = 332
# Create Token Account
TITLE__CREATE_TOKEN_ACCOUNT = 333
# Signer:
LIST_KEY__SIGNER__COLON = 334
# Token Transfer
TITLE__TOKEN_TRANSFER = 335
# From (Token Account):
LIST_KEY__FROM_TOKEN_ACCOUNT__COLON = 336
# To (Token Account):
LIST_KEY__TO_TOKEN_ACCOUNT__COLON = 337
# Format:
LIST_KEY__FORMAT__COLON = 338
# Message Hash:
LIST_KEY__MESSAGE_HASH__COLON = 339
# Unknown
LIST_VALUE__UNKNOWN__COLON = 340
# Memo
TITLE__MEMO = 341
# Update Mode
ITEM__UPDATE_MODE = 342
# Switch to Update Mode
TITLE__SWITCH_TO_UPDATE_MODE = 343
# Boardloader
ITEM__BOARDLOADER = 344
# Switch to Boardloader
TITLE__SWITCH_TO_BOARDLOADER = 345
# Do you want to restart device into boardloader?
SUBTITLE__SWITCH_TO_BOARDLOADER_RECONFIRM = 346
# Keyboard Haptic
ITEM__KEYBOARD_HAPTIC = 347
TITLE__KEYBOARD_HAPTIC = 347
# Haptic
ITEM__HAPTIC = 348
# Strict
ITEM__STATUS__STRICT = 349
OPTION__STRICT = 349
# Safety Checks
ITEM__SAFETY_CHECKS = 350
TITLE__SAFETY_CHECKS = 350
# Prompt
ITEM__STATUS__PROMPT = 351
OPTION__PROMPT = 351
# Safety checks are permanently disabled. It is highly recommended to promote
# the security level to strict.
CONTENT__SAFETY_CHECKS_PERMANENTLY_PROMPT__HINT = 352
# High security level, protect you from performing non-standard transactions o
# r extreme fees.
CONTENT__SAFETY_CHECKS_STRICT__HINT = 353
# Safety checks are temporarily disabled. It will revert to strict level after
# restart.
CONTENT__SAFETY_CHECKS_TEMPORARILY_PROMPT__HINT = 354
# Do you want to enforce strict safety checks? It will provide full security p
# rotection.
SUBTITLE__SET_SAFETY_CHECKS_TO_STRICT = 355
# Set Safety Checks to Strict
TITLE__SET_SAFETY_CHECKS_TO_STRICT = 356
# Set Safety Checks to Prompt
TITLE__SET_SAFETY_CHECKS_TO_PROMPT = 357
# It will temporarily allow you to perform some actions with potentially risky
# .
SUBTITLE__SET_SAFETY_CHECKS_TO_PROMPT = 358
# Disable Safety Checks
TITLE__DISABLE_SAFETY_CHECKS = 359
# Slide to Disable
BUTTON__SLIDE_TO_DISABLE = 360
...
# Note:
LIST_KEY__NOTE__COLON = 394
# Type:
LIST_KEY__TYPE__COLON = 395
# Close Remainder To:
LIST_KEY__CLOSE_REMAINDER_TO__COLON = 396
# Rekey To:
LIST_KEY__REKEY_TO__COLON = 397
# Freeze Account:
LIST_KEY__FREEZE_ACCOUNT__COLON = 398
# Asset ID:
LIST_KEY__ASSET_ID__COLON = 399
# Freeze Asset ID:
LIST_KEY__FREEZE_ASSET_ID__COLON = 400
# Asset Frozen?
LIST_KEY__ASSET_FROZEN__QUESTION = 401
# True
LIST_VALUE__TRUE = 402
# False
LIST_VALUE__FALSE = 403
# Asset Amount:
LIST_KEY__ASSET_ACOUNT__COLON = 404
# Asset Receiver:
LIST_KEY__ASSET_RECEIVER__COLON = 405
# Asset Sender:
LIST_KEY__ASSET_SENDER__COLON = 406
# Transfer Asset ID:
LIST_KEY__TRANSFER_ASSET_ID__COLON = 407
# Close Asset To:
LIST_KEY__CLOSE_ASSET_TO__COLON = 408
# Asset Parameters:
LIST_KEY__ASSER_PARAMETERS__COLON = 409
# Asset Name:
LIST_KEY__ASSET_NAME__COLON = 410
# URL:
LIST_KEY__URL__COLON = 411
# Manager Address:
LIST_KEY__MANAGER_ADDRESS__COLON = 412
# Reserve Address:
LIST_KEY__RESERVE_ADDRESS__COLON = 413
# Claw Back Address:
LIST_KEY__CLAW_BACK_ADDRESS__COLON = 414
# Default Frozen?
LIST_KEY__FREEZE_ADDRESS__QUESTION = 415
# Freeze Address:
LIST_KEY__FREEZE_ADDRESS__COLON = 416
# Total:
LIST_KEY__TOTAL__COLON = 417
# Decimals:
LIST_KEY__DECIMALS__COLON = 418
# Unit Name:
LIST_KEY__UNIT_NAME__COLON = 419
# Metadata Hash:
LIST_KEY__METADATA_HASH__COLON = 420
# VRF Public Key:
LIST_KEY__VRF_PUBLIC_KEY__COLON = 421
# Vote Public Key:
LIST_KEY__VOTE_PUBLIC_KEY__COLON = 422
# Revocation Address:
LIST_KEY__REVOCATION_ADDRESS__COLON = 423
# State Proof Public Key:
LIST_KEY__STATE_PROOF_PUBLIC_KEY__COLON = 424
# Nonparticipation (Reward)?
LIST_KEY__NONPARTICIPATION__COLON = 425
# Payment
TITLE__PAYMENT = 426
# Asset Freeze
TITLE__ASSET_FREEZE = 427
# Asset Transfer
TITLE__ASSET_TRANSFER = 428
# Asset Configuration
TITLE__ASSET_CONFIGURATION = 429
# Key Registration
TITLE__KEY_REGISTRATION = 430
# Unknown Transaction
TITLE__UNKNOWN_TRANSACTION = 431
# Destination Tag:
LIST_KEY__DESTINATION_TAG__COLON = 432
# fmt: on
