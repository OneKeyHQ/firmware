...
if utils.EMULATOR:
    ...
    if device.get_language() in ["en"] and device.is_initialized():
        font_PJSBOLD36 = lv.font_pljs_bold_36
        font_PJSBOLD32 = lv.font_pljs_bold_36
        font_PJSBOLD24 = lv.font_pljs_bold_24
        font_PJSBOLD20 = lv.font_pljs_bold_24
        font_PJSMID28 = lv.font_pljs_regular_24
        font_PJSMID24 = lv.font_pljs_regular_24
        font_PJSMID20 = lv.font_pljs_regular_24
        font_PJSREG24 = lv.font_pljs_regular_24
        font_MONO28 = lv.font_pljs_regular_24
        font_MONO24 = lv.font_pljs_regular_24
    else:
