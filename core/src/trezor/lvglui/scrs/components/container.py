...
class ContainerFlexCol(lv.obj):
    def __init__(self, parent, align_base, size: tuple = (lv.pct(100), 600), align = lv.ALIGN.OUT_BOTTOM_MID, pos:tuple=(0, 30)) -> None:
...
class ContanierGrid(lv.obj):
    def __init__(self, parent, align_base, size: tuple = (lv.pct(100), 600), align = lv.ALIGN.OUT_BOTTOM_MID, pos:tuple=(0, 30), cell_size:tuple=(213,192)) -> None:
        super().__init__(parent)
