...
class ImgBottonGridItem(lv.imgbtn):
    ...
    def __init__(self, parent, col_num, row_num, bg_img_path: str, img_path_other:str="A:/res/checked_48.png"):
        super().__init__(parent)
        self.set_grid_cell(lv.GRID_ALIGN.STRETCH, col_num, 1,
                        lv.GRID_ALIGN.STRETCH, row_num, 1)
