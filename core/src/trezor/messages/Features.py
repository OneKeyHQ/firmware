...
class Features(p.MessageType):
    ...
    def get_fields(cls) -> Dict:
        return {
            ...
            101: ('ble_name', p.UnicodeType, None),
            102: ('ble_ver', p.UnicodeType, None),
            103: ('ble_enable', p.BoolType, None),
            104: ('se_enable', p.BoolType, None),
            106: ('se_ver', p.UnicodeType, None),
            107: ('backup_only', p.BoolType, None),
        }
