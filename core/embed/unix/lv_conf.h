...
#define LV_USE_FS_POSIX 1
    ...
    #define LV_FS_POSIX_PATH "/home/dahuanzi/trezor/onekey-firmware/core/src/trezor/ui/layouts/lvglui"         /*Set the working directory. File/directory paths will be appended to it.*/
