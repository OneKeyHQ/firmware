...
STATIC const mp_rom_map_elem_t mp_module_trezorutils_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_ONEKEY_VERSION_MAJOR),
     MP_ROM_INT(ONEKEY_VERSION_MAJOR)},
    {MP_ROM_QSTR(MP_QSTR_ONEKEY_VERSION_MINOR),
     MP_ROM_INT(ONEKEY_VERSION_MINOR)},
    {MP_ROM_QSTR(MP_QSTR_ONEKEY_VERSION_PATCH),
     MP_ROM_INT(ONEKEY_VERSION_PATCH)},
