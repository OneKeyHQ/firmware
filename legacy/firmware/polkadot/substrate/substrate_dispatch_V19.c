...
_readMethod_staking_bond_V19(parser_context_t* c, pd_staking_bond_V19_t* m) {
...
__Z_INLINE parser_error_t _readMethod_staking_chill_V19(void) {
  return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_session_purge_keys_V19(void) {
  return parser_ok;
}

__Z_INLINE parser_error_t
_readMethod_utility_batch_V19(parser_context_t* c, pd_utility_batch_V19_t* m) {
...
parser_error_t _readMethod_V19(parser_context_t* c, uint8_t moduleIdx,
  ...
  switch (callPrivIdx) {
    case 1280: /* module 5 call 0 */
      CHECK_ERROR(_readMethod_balances_transfer_V19(
          c, &method->nested.balances_transfer_V19))
      break;
    case 1282: /* module 5 call 2 */
      CHECK_ERROR(_readMethod_balances_force_transfer_V19(
          c, &method->nested.balances_force_transfer_V19))
      break;
    case 1283: /* module 5 call 3 */
      CHECK_ERROR(_readMethod_balances_transfer_keep_alive_V19(
          c, &method->nested.balances_transfer_keep_alive_V19))
      break;
    case 1284: /* module 5 call 4 */
      CHECK_ERROR(_readMethod_balances_transfer_all_V19(
          c, &method->basic.balances_transfer_all_V19))
      break;
    case 1792: /* module 7 call 0 */
      CHECK_ERROR(
          _readMethod_staking_bond_V19(c, &method->nested.staking_bond_V19))
      break;
    case 1793: /* module 7 call 1 */
      CHECK_ERROR(_readMethod_staking_bond_extra_V19(
          c, &method->basic.staking_bond_extra_V19))
      break;
    case 1794: /* module 7 call 2 */
      CHECK_ERROR(
          _readMethod_staking_unbond_V19(c, &method->nested.staking_unbond_V19))
      break;
    case 1795: /* module 7 call 3 */
      CHECK_ERROR(_readMethod_staking_withdraw_unbonded_V19(
          c, &method->basic.staking_withdraw_unbonded_V19))
      break;
    case 1796: /* module 7 call 4 */
      CHECK_ERROR(_readMethod_staking_validate_V19(
          c, &method->basic.staking_validate_V19))
      break;
    case 1797: /* module 7 call 5 */
      CHECK_ERROR(_readMethod_staking_nominate_V19(
          c, &method->nested.staking_nominate_V19))
      break;
    case 1798: /* module 7 call 6 */
      CHECK_ERROR(_readMethod_staking_chill_V19())
      break;
    case 1799: /* module 7 call 7 */
      CHECK_ERROR(_readMethod_staking_set_payee_V19(
          c, &method->basic.staking_set_payee_V19))
      break;
    case 1800: /* module 7 call 8 */
      CHECK_ERROR(_readMethod_staking_set_controller_V19(
          c, &method->nested.staking_set_controller_V19))
      break;
    case 1810: /* module 7 call 18 */
      CHECK_ERROR(_readMethod_staking_payout_stakers_V19(
          c, &method->basic.staking_payout_stakers_V19))
      break;
    case 1811: /* module 7 call 19 */
      CHECK_ERROR(
          _readMethod_staking_rebond_V19(c, &method->basic.staking_rebond_V19))
      break;
    case 2304: /* module 9 call 0 */
      CHECK_ERROR(_readMethod_session_set_keys_V19(
          c, &method->basic.session_set_keys_V19))
      break;
    case 2305: /* module 9 call 1 */
      CHECK_ERROR(_readMethod_session_purge_keys_V19())
      break;
    case 6656: /* module 26 call 0 */
      CHECK_ERROR(
          _readMethod_utility_batch_V19(c, &method->basic.utility_batch_V19))
      break;
    case 6658: /* module 26 call 2 */
      CHECK_ERROR(_readMethod_utility_batch_all_V19(
          c, &method->basic.utility_batch_all_V19))
      break;
    case 6660: /* module 26 call 4 */
      CHECK_ERROR(_readMethod_utility_force_batch_V19(
          c, &method->basic.utility_force_batch_V19))
      break;
    case 18688: /* module 73 call 0 */
      CHECK_ERROR(_readMethod_crowdloan_create_V19(
          c, &method->basic.crowdloan_create_V19))
      break;
    case 18689: /* module 73 call 1 */
      CHECK_ERROR(_readMethod_crowdloan_contribute_V19(
          c, &method->basic.crowdloan_contribute_V19))
      break;
    case 18690: /* module 73 call 2 */
      CHECK_ERROR(_readMethod_crowdloan_withdraw_V19(
          c, &method->basic.crowdloan_withdraw_V19))
      break;
    case 18691: /* module 73 call 3 */
      CHECK_ERROR(_readMethod_crowdloan_refund_V19(
          c, &method->basic.crowdloan_refund_V19))
      break;
    case 18692: /* module 73 call 4 */
      CHECK_ERROR(_readMethod_crowdloan_dissolve_V19(
          c, &method->basic.crowdloan_dissolve_V19))
      break;
    case 18693: /* module 73 call 5 */
      CHECK_ERROR(
          _readMethod_crowdloan_edit_V19(c, &method->basic.crowdloan_edit_V19))
      break;
    case 18694: /* module 73 call 6 */
      CHECK_ERROR(_readMethod_crowdloan_add_memo_V19(
          c, &method->basic.crowdloan_add_memo_V19))
      break;
    case 18695: /* module 73 call 7 */
      CHECK_ERROR(
          _readMethod_crowdloan_poke_V19(c, &method->basic.crowdloan_poke_V19))
      break;
    case 18696: /* module 73 call 8 */
      CHECK_ERROR(_readMethod_crowdloan_contribute_all_V19(
          c, &method->basic.crowdloan_contribute_all_V19))
      break;
      ...
      switch (itemIdx) {
        case 0: /* balances_transfer_V19 - dest */;
          return _toStringAccountIdLookupOfT_V19(
              &m->nested.balances_transfer_V19.dest, outValue, outValueLen,
              pageIdx, pageCount);
        case 1: /* balances_transfer_V19 - amount */;
          return _toStringCompactBalance(
              &m->nested.balances_transfer_V19.amount, outValue, outValueLen,
              pageIdx, pageCount);
        default:
    ...
    case 1282: /* module 5 call 2 */
      switch (itemIdx) {
        case 0: /* balances_force_transfer_V19 - source */;
          return _toStringAccountIdLookupOfT_V19(
              &m->nested.balances_force_transfer_V19.source, outValue,
              outValueLen, pageIdx, pageCount);
        case 1: /* balances_force_transfer_V19 - dest */;
          return _toStringAccountIdLookupOfT_V19(
              &m->nested.balances_force_transfer_V19.dest, outValue,
              outValueLen, pageIdx, pageCount);
        case 2: /* balances_force_transfer_V19 - amount */;
          return _toStringCompactBalance(
              &m->nested.balances_force_transfer_V19.amount, outValue,
              outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 1283: /* module 5 call 3 */
      switch (itemIdx) {
        case 0: /* balances_transfer_keep_alive_V19 - dest */;
          return _toStringAccountIdLookupOfT_V19(
              &m->nested.balances_transfer_keep_alive_V19.dest, outValue,
              outValueLen, pageIdx, pageCount);
        case 1: /* balances_transfer_keep_alive_V19 - amount */;
          return _toStringCompactBalance(
              &m->nested.balances_transfer_keep_alive_V19.amount, outValue,
              outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 1284: /* module 5 call 4 */
      switch (itemIdx) {
        case 0: /* balances_transfer_all_V19 - dest */;
          return _toStringAccountIdLookupOfT_V19(
              &m->basic.balances_transfer_all_V19.dest, outValue, outValueLen,
              pageIdx, pageCount);
        case 1: /* balances_transfer_all_V19 - keep_alive */;
          return _toStringbool(&m->basic.balances_transfer_all_V19.keep_alive,
    ...
    case 1792: /* module 7 call 0 */
      switch (itemIdx) {
        case 0: /* staking_bond_V19 - controller */;
          return _toStringAccountIdLookupOfT_V19(
              &m->nested.staking_bond_V19.controller, outValue, outValueLen,
              pageIdx, pageCount);
        case 1: /* staking_bond_V19 - amount */;
          return _toStringCompactBalance(&m->nested.staking_bond_V19.amount,
                                         outValue, outValueLen, pageIdx,
                                         pageCount);
        case 2: /* staking_bond_V19 - payee */;
          return _toStringRewardDestination_V19(
              &m->nested.staking_bond_V19.payee, outValue, outValueLen, pageIdx,
              pageCount);
        default:
          return parser_no_data;
      }
    case 1793: /* module 7 call 1 */
      switch (itemIdx) {
        case 0: /* staking_bond_extra_V19 - amount */;
          return _toStringCompactBalance(
              &m->basic.staking_bond_extra_V19.amount, outValue, outValueLen,
              pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 1794: /* module 7 call 2 */
      switch (itemIdx) {
        case 0: /* staking_unbond_V19 - amount */;
          return _toStringCompactBalance(&m->nested.staking_unbond_V19.amount,
                                         outValue, outValueLen, pageIdx,
                                         pageCount);
        default:
          return parser_no_data;
      ...
      switch (itemIdx) {
        case 0: /* staking_validate_V19 - prefs */;
          return _toStringValidatorPrefs_V19(
              &m->basic.staking_validate_V19.prefs, outValue, outValueLen,
              pageIdx, pageCount);
        default:
          return parser_no_data;
      }
      ...
      switch (itemIdx) {
        case 0: /* staking_nominate_V19 - targets */;
          return _toStringVecAccountIdLookupOfT_V19(
              &m->nested.staking_nominate_V19.targets, outValue, outValueLen,
              pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    ...
    case 1799: /* module 7 call 7 */
      switch (itemIdx) {
        case 0: /* staking_set_payee_V19 - payee */;
          return _toStringRewardDestination_V19(
              &m->basic.staking_set_payee_V19.payee, outValue, outValueLen,
              pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 1800: /* module 7 call 8 */
      switch (itemIdx) {
        case 0: /* staking_set_controller_V19 - controller */;
          return _toStringAccountIdLookupOfT_V19(
              &m->nested.staking_set_controller_V19.controller, outValue,
              outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
      ...
      switch (itemIdx) {
        case 0: /* staking_payout_stakers_V19 - validator_stash */;
          return _toStringAccountId_V19(
              &m->basic.staking_payout_stakers_V19.validator_stash, outValue,
              outValueLen, pageIdx, pageCount);
        case 1: /* staking_payout_stakers_V19 - era */;
          return _toStringEraIndex_V19(&m->basic.staking_payout_stakers_V19.era,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
        default:
          return parser_no_data;
    ...
    case 1811: /* module 7 call 19 */
      switch (itemIdx) {
        case 0: /* staking_rebond_V19 - amount */;
          return _toStringCompactBalance(&m->basic.staking_rebond_V19.amount,
                                         outValue, outValueLen, pageIdx,
                                         pageCount);
        default:
          return parser_no_data;
    ...
    case 2304: /* module 9 call 0 */
      switch (itemIdx) {
        case 0: /* session_set_keys_V19 - keys */;
          return _toStringKeys_V19(&m->basic.session_set_keys_V19.keys,
                                   outValue, outValueLen, pageIdx, pageCount);
        case 1: /* session_set_keys_V19 - proof */;
          return _toStringBytes(&m->basic.session_set_keys_V19.proof, outValue,
                                outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    ...
    case 6656: /* module 26 call 0 */
      switch (itemIdx) {
        case 0: /* utility_batch_V19 - calls */;
          return _toStringVecCall(&m->basic.utility_batch_V19.calls, outValue,
                                  outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 6658: /* module 26 call 2 */
      switch (itemIdx) {
        case 0: /* utility_batch_all_V19 - calls */;
          return _toStringVecCall(&m->basic.utility_batch_all_V19.calls,
                                  outValue, outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 6660: /* module 26 call 4 */
      switch (itemIdx) {
        case 0: /* utility_force_batch_V19 - calls */;
          return _toStringVecCall(&m->basic.utility_force_batch_V19.calls,
                                  outValue, outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18688: /* module 73 call 0 */
      switch (itemIdx) {
        case 0: /* crowdloan_create_V19 - index */;
          return _toStringCompactu32(&m->basic.crowdloan_create_V19.index,
                                     outValue, outValueLen, pageIdx, pageCount);
        case 1: /* crowdloan_create_V19 - cap */;
          return _toStringCompactu128(&m->basic.crowdloan_create_V19.cap,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
        case 2: /* crowdloan_create_V19 - first_period */;
          return _toStringCompactu32(
              &m->basic.crowdloan_create_V19.first_period, outValue,
              outValueLen, pageIdx, pageCount);
        case 3: /* crowdloan_create_V19 - last_period */;
          return _toStringCompactu32(&m->basic.crowdloan_create_V19.last_period,
                                     outValue, outValueLen, pageIdx, pageCount);
        case 4: /* crowdloan_create_V19 - end */;
          return _toStringCompactu32(&m->basic.crowdloan_create_V19.end,
                                     outValue, outValueLen, pageIdx, pageCount);
        case 5: /* crowdloan_create_V19 - verifier */;
          return _toStringOptionMultiSigner_V19(
              &m->basic.crowdloan_create_V19.verifier, outValue, outValueLen,
              pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18689: /* module 73 call 1 */
      switch (itemIdx) {
        case 0: /* crowdloan_contribute_V19 - index */;
          return _toStringCompactu32(&m->basic.crowdloan_contribute_V19.index,
                                     outValue, outValueLen, pageIdx, pageCount);
        case 1: /* crowdloan_contribute_V19 - amount */;
          return _toStringCompactu128(&m->basic.crowdloan_contribute_V19.amount,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
        case 2: /* crowdloan_contribute_V19 - signature */;
          return _toStringOptionMultiSignature_V19(
              &m->basic.crowdloan_contribute_V19.signature, outValue,
              outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18690: /* module 73 call 2 */
      switch (itemIdx) {
        case 0: /* crowdloan_withdraw_V19 - who */;
          return _toStringAccountId_V19(&m->basic.crowdloan_withdraw_V19.who,
                                        outValue, outValueLen, pageIdx,
                                        pageCount);
        case 1: /* crowdloan_withdraw_V19 - index */;
          return _toStringCompactu32(&m->basic.crowdloan_withdraw_V19.index,
                                     outValue, outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18691: /* module 73 call 3 */
      switch (itemIdx) {
        case 0: /* crowdloan_refund_V19 - index */;
          return _toStringCompactu32(&m->basic.crowdloan_refund_V19.index,
                                     outValue, outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18692: /* module 73 call 4 */
      switch (itemIdx) {
        case 0: /* crowdloan_dissolve_V19 - index */;
          return _toStringCompactu32(&m->basic.crowdloan_dissolve_V19.index,
                                     outValue, outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18693: /* module 73 call 5 */
      switch (itemIdx) {
        case 0: /* crowdloan_edit_V19 - index */;
          return _toStringCompactu32(&m->basic.crowdloan_edit_V19.index,
                                     outValue, outValueLen, pageIdx, pageCount);
        case 1: /* crowdloan_edit_V19 - cap */;
          return _toStringCompactu128(&m->basic.crowdloan_edit_V19.cap,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
        case 2: /* crowdloan_edit_V19 - first_period */;
          return _toStringCompactu32(&m->basic.crowdloan_edit_V19.first_period,
                                     outValue, outValueLen, pageIdx, pageCount);
        case 3: /* crowdloan_edit_V19 - last_period */;
          return _toStringCompactu32(&m->basic.crowdloan_edit_V19.last_period,
                                     outValue, outValueLen, pageIdx, pageCount);
        case 4: /* crowdloan_edit_V19 - end */;
          return _toStringCompactu32(&m->basic.crowdloan_edit_V19.end, outValue,
                                     outValueLen, pageIdx, pageCount);
        case 5: /* crowdloan_edit_V19 - verifier */;
          return _toStringOptionMultiSigner_V19(
              &m->basic.crowdloan_edit_V19.verifier, outValue, outValueLen,
              pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18694: /* module 73 call 6 */
      switch (itemIdx) {
        case 0: /* crowdloan_add_memo_V19 - index */;
          return _toStringParaId_V19(&m->basic.crowdloan_add_memo_V19.index,
                                     outValue, outValueLen, pageIdx, pageCount);
        case 1: /* crowdloan_add_memo_V19 - memo */;
          return _toStringVecu8(&m->basic.crowdloan_add_memo_V19.memo, outValue,
                                outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18695: /* module 73 call 7 */
      switch (itemIdx) {
        case 0: /* crowdloan_poke_V19 - index */;
          return _toStringParaId_V19(&m->basic.crowdloan_poke_V19.index,
                                     outValue, outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
    case 18696: /* module 73 call 8 */
      switch (itemIdx) {
        case 0: /* crowdloan_contribute_all_V19 - index */;
          return _toStringCompactu32(
              &m->basic.crowdloan_contribute_all_V19.index, outValue,
              outValueLen, pageIdx, pageCount);
        case 1: /* crowdloan_contribute_all_V19 - signature */;
          return _toStringOptionMultiSignature_V19(
              &m->basic.crowdloan_contribute_all_V19.signature, outValue,
              outValueLen, pageIdx, pageCount);
        default:
          return parser_no_data;
      }
